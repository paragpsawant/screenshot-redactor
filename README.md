...
| People & places | Names, street addresses, dates of birth | [GLiNER PII](https://huggingface.co/urchade/gliner_multi_pii-v1) (zero-shot NER) |
| Faces | Profile photos, webcam tiles | [YuNet](https://github.com/opencv/opencv_zoo/tree/main/models/face_detection_yunet) |
...
client = Client("<your-username>/screenshot-redactor")
...
MCP clients: add `https://<your-username>-screenshot-redactor.hf.space/gradio_api/mcp/`.
...
[RapidOCR](https://github.com/RapidAI/RapidOCR) · [GLiNER](https://github.com/urchade/GLiNER) ·
[YuNet](https://github.com/opencv/opencv_zoo) (MIT, bundled) · [OpenCV](https://opencv.org) · [Gradio](https://gradio.app)
